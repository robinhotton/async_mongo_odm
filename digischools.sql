...
--
-- Base de données : `digischools`
--
CREATE DATABASE IF NOT EXISTS `digischools` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `digischools`;
...
INSERT INTO `t_matiere` (`idmatiere`, `nom`) VALUES
(1, 'LECTURE-CP'),
(2, 'LECTURE-CE1'),
(3, 'SCIENCES & DECOUVERTES'),
(4, 'MATHEMATIQUES'),
(5, 'EVEIL SPORTIF');
...
INSERT INTO `t_notes` (`idnotes`, `date_saisie`, `ideleve`, `idclasse`,
 `idmatiere`, `idprof`, `idtrimestre`, `note`, `avis`, `avancement`) 
 VALUES
(1, '2019-10-15 08:07:03', 2, 2, 5, 2, 1, 12, 'Travail à approfondir', 0),
(2, '2019-11-15 08:07:03', 3, 1, 5, 2, 1, 15, 'Bon travail', 0),
(3, '2019-12-15 08:07:03', 2, 2, 5, 2, 1, 13, 'Travail en progression', 0)
;
...
--
-- Déchargement des données de la table `t_trimestre`
--

INSERT INTO `t_trimestre` (`idtrimestre`, `nom`, `date`) VALUES
(1, 'TRIM01', '2023-12-01 09:08:03'),
(2, 'TRIM02', '2024-03-08 09:08:25'),
(3, 'TRIM03', '2024-06-21 08:08:40');
...
--
ALTER TABLE `t_notes`
  MODIFY `idnotes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `t_trimestre`
  MODIFY `idtrimestre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
